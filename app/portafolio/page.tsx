...
const PagePortafolio = () => {
    ...
    const Proyectos: propsProyect[] = [
        {name: 'Tarjet v2', subTitle: 'Desarrollo de aplicación web de tarjetero digital, versión 2 con CSR y SSR.', link: '/portafolio/tarjetv2', image: '/imagenes/Tarjet-2.webp'},
